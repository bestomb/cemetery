...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">系统角色列表</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <button type="button" class="btn btn-default btn-lg add">添加系统管理角色</button>
                        <button type="button" class="btn btn-danger btn-lg delete">删除系统管理角色</button>
                    </div>
                        ...
                        if (response.data.totalCount > 0) {
                            ...
                            $(response.data.list).each(function () {
                                ...
                                tableBody += '<tr>'
                                        ...
                                        + '<td>' + this.id + '</td>'
                                        + '<td>' + this.name + '</td>'
                                        + '<td title="' + this.remark + '">' + subRemark + '</td>'
                                        + '<td>'
