            ...
            <div class="col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <button type="button" class="btn btn-default btn-lg add">添加模型</button>
                        <button type="button" class="btn btn-danger btn-lg delete">删除模型</button>
                    </div>
    ...
    function addHoverDom(treeId, treeNode) {
        ...
        if (treeNode.parentId == "0") {
            addStr = "<span class='button add' id='addBtn_" + treeNode.tId
                    + "' title='添加模型分类' onfocus='this.blur();'></span>";
        }
        ...
        if (btn) btn.bind("click", function () {
            var nodeInfo = {"name": "新模型分类", "parentId": treeNode.id};
            //异步添加子节点数据
            $.ajax({
                type: "post",
