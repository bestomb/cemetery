...
public class GoodsServiceImpl implements IGoodsService {
    ...
    public PageResponse getGoodsPageList(Mall mall, Pager page) throws EqianyuanException {
        ...
        if (mall.getMallType() == 1) { // 官方商城
            ...
            dataCount = plantsAndAnimalsDao.getPageListCount(mall);
        }
        if (dataCount == 0) {
        ...
        if (mall.getMallType() == 1) { // 官方商城
            ...
            entityList = plantsAndAnimalsDao.getPageList(mall, page);
        }
    ...
    public Object getGoodsById(Mall mall) throws EqianyuanException {
        ...
        if (mall.getMallType() == 1) { // 官方商城
            ...
            goods = plantsAndAnimalsDao.selectByPrimaryKey(mall.getGoodsId());
        }
        // 商品数据是否存在
